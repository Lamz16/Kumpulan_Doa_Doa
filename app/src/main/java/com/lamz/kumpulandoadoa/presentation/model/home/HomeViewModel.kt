package com.lamz.kumpulandoadoa.presentation.model.home
...
class HomeViewModel(private val kumpulanDoaUseCase: KumpulanDoaUseCase) : ViewModel() {
    val doa = kumpulanDoaUseCase.getAllDoa().asLiveData()
